<x-layout>
    ...
    <div class="container mx-auto py-4">
        <form method="POST" action="{{ route('products.store') }}" class="max-w-sm mx-auto">
            ...
            <a href="/products" class="focus:outline-none text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:focus:ring-yellow-900">Cancel</a>
        </form>
    </div>
